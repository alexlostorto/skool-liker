...
let delay = 500; // Example: 100 milliseconds
let working = false; // Ensures comments are all liked before re-checking
let execute = true;
...
setInterval(function() {
    if (working) {return} // Likes are still being executed
    if (!execute) {return} // Extension has not been activated
    main();
}, 1000)
